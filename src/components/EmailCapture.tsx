...
export default function EmailCapture() {
  ...
  return (
    <section className="bg-brand-black border-t border-brand-red px-4 py-16 md:px-8 md:py-20">
      <div className="mx-auto max-w-2xl text-center">
        ...
        {submitted ? (
          <p className="mt-8 text-lg text-white font-body">You are on the list.</p>
        ) : (
          <form
            onSubmit={(e) => {
              e.preventDefault();
